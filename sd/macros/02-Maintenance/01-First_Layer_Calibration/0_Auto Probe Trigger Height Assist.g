...
G29 S2			; Clear mesh bed compensation perameters
 M564 S0		; Disable Axis limit

; Preheat to probing temps
;
M291 P"Preheating to bed to 65 and nozzle to 220 for accurate probing" R"Proceed?" S3
T0			; Activate first tool
M104 S220		; Set nozzle to 210 and release
M140 S65		; Set bed temp to 60 and release

; home all axis
;
G28				; Home all axis
M190 S65		; Set bed to 60 and wait
M109 S220		; Set nozzle to 210 and wait
