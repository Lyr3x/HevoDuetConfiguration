...
;
G28 XY
M98 P"/macros/02-Maintenance/01-First_Layer_Calibration/1_Center Nozzle on Bed"
G28 Z			; Home all axis
...
;
M291 P"Preheating the bed to 65 and nozzle to 220 for accurate probing" T0
M104 S210		; Set nozzle to 220 and release
M190 S60		; Set bed to 65 and wait
...
G1 X20 Y270 F6000	; Move to front right corner
...
G1 X265 Y10 F6000	; Move to back left
...
G1 Z2			; Move to Z2 for clearance
G1 X265 Y270 F6000	; Move to front left corner

M400
M291 P"Adjust point 3 using a piece of paper and screw driver. Use the jog buttons if needed." R"Adjustment Point 2" S2 Z1

; Move to leveling point 4
G1 Z2			; Move to Z2 for clearance
G1 X20 Y10 F6000	; Move to back right

M400
M291 P"Adjust point 4 using a piece of paper and screw driver. Use the jog buttons if needed." R"Adjustment Point 3" S2 Z1
